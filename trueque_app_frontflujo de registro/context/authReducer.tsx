...
import { PUTloginUser, registerUser } from '../api/auth.api'
...
function useAuth() {
  ...
  async function handleRegister(user: CreateUserModel): Promise<boolean> {
  ...
  return { state, handleLogin, handleLogout, handleRegister }
}
